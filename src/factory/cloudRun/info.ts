...
table1.push(
    [ chalk.greenBright.bold('1'), chalk.greenBright.bold('GCloud CLI'), chalk.bold('Make sure you have GCloud CLI installed on your device.')]
    ,[ chalk.greenBright.bold('2'), chalk.greenBright.bold('Authentication'), chalk.bold('Authenticate using the command line. Use the following command: \n') + chalk.red('gcloud auth application-default login')]
